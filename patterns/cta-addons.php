<?php
/**
 * Title: CTA — Add-On Services
 * Slug: alaska/cta-addons
 * Categories: alaska-homepage
 * Description: Add-on services call-to-action card (driver, lounge, baggage).
 * Keywords: CTA, services, lounge, baggage
 */
...
<h3 class="wp-block-heading has-headline-sm-font-size">Add-On Services</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"on-surface-variant","fontSize":"body-sm"} -->
<p class="has-on-surface-variant-color has-text-color has-body-sm-font-size">Private driver service, airport lounge access, priority boarding, and extra baggage — customize your journey.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-tonal","style":{"typography":{"fontSize":"0.875rem"}},"width":100} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-tonal"><a class="wp-block-button__link has-custom-font-size wp-element-button" style="font-size:0.875rem" href="<?php echo $services_url; ?>">View Services →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
