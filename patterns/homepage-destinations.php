 ...
 * Categories: alaska-homepage, alaska-destination
...
<p class="has-secondary-color has-text-color has-body-sm-font-size" style="font-weight:700"><a href="<?php echo esc_url( $destinations_url ); ?>">Explore all destinations →</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
