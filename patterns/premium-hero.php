 ...
 * Keywords: premium, hero, cabin, upgrade
 */

$flights_url = home_url( '/flights/' );
$hero_image  = 'https://images.unsplash.com/photo-1540339832862-474599807836?auto=format&fit=crop&w=1800&q=80';
?>
<!-- wp:cover {"url":"<?php echo esc_url( $hero_image ); ?>","dimRatio":55,"overlayColor":"primary","isUserOverlayColor":true,"minHeight":700,"minHeightUnit":"px","isDark":true,"align":"full","style":{"spacing":{"padding":{"left":"var:preset|spacing|40","right":"var:preset|spacing|40","top":"var:preset|spacing|120","bottom":"var:preset|spacing|120"}}}} -->
<div class="wp-block-cover alignfull is-dark" style="padding-top:var(--wp--preset--spacing--120);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--120);padding-left:var(--wp--preset--spacing--40);min-height:700px"><span aria-hidden="true" class="wp-block-cover__background has-primary-background-color has-background-dim-55 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $hero_image ); ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained"}} -->
...
<div class="wp-block-button is-style-cta-gradient"><a class="wp-block-button__link has-custom-font-size wp-element-button" style="font-size:1.125rem" href="<?php echo esc_url( $flights_url ); ?>">Search Premium Flights →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
