 ...
 * Keywords: homepage, hero, booking, flights
 */
...
<!-- wp:alaska/booking-widget {"actionUrl":"<?php echo esc_url( $flights_url ); ?>","defaultFrom":"Seattle (SEA)","defaultTo":"San Francisco (SFO)"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
