...
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-tonal"><a class="wp-block-button__link has-custom-font-size wp-element-button" style="font-size:0.875rem" href="#">Browse Cars →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
