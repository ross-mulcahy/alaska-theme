 ...
 * Keywords: premium, upgrade, flights, cabin
 */
...
<div class="wp-block-button"><a class="wp-block-button__link has-custom-font-size wp-element-button" style="font-size:1.125rem" href="<?php echo esc_url( $flights_url ); ?>">Upgrade to Premium</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
